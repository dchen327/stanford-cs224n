...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden_weight = nn.Parameter(torch.Tensor(
    ...
    def forward(self, w):
        ...
        hidden = nn.functional.relu(torch.matmul(
            embed, self.embed_to_hidden_weight) + self.embed_to_hidden_bias)
        logits = torch.matmul(
            hidden, self.hidden_to_logits_weight) + self.hidden_to_logits_bias
        # END YOUR CODE
        return logits
